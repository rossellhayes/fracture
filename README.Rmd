...
Use **fracture** to find the best approximations of π given for each maximum denominator.

```{r}
unique(purrr::map_chr(1:17000, ~ fracture(pi, max_denom = .x)))
```

Isn't is interesting that there's such a wide gap between 355/113 and 52163/16604?
